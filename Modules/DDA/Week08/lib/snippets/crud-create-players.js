...
function createPlayer(e, userId) {
  ...
  //literal object playerData 
  //with some fixed sample data 
  var playerData = {
    active: true,
...
//only when there's a change in the reference data
onValue(playerRef, (snapshot) => {
  //const data = snapshot.val();
  //think about what you want to display/update to users
